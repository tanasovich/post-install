...
Source0:        https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-%{version}.noarch.rpm
BuildArch:      noarch
...
rpm2cpio %{buildroot}/tmp/rpmfusion-free-release.rpm | cpio -idv --quiet -D %{buildroot}
